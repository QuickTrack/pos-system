...
export default function POSPage() {
  ...
  const DEMO_PRODUCTS = [
    { _id: '1', name: 'Samsung Galaxy A14', sku: 'ELEC001', barcode: '1234567890123', retailPrice: 18999, wholesalePrice: 17000, stockQuantity: 50, category: { name: 'Electronics' }, baseUnit: 'Pcs', units: [{ name: 'Pcs', price: 18999, conversionQty: 1 }] },
    { _id: '2', name: 'Sony WH-1000XM5 Headphones', sku: 'ELEC002', barcode: '1234567890124', retailPrice: 32999, wholesalePrice: 30000, stockQuantity: 25, category: { name: 'Electronics' }, baseUnit: 'Pcs', units: [{ name: 'Pcs', price: 32999, conversionQty: 1 }] },
    { _id: '3', name: 'HP Laptop 15s', sku: 'ELEC003', barcode: '1234567890125', retailPrice: 74999, wholesalePrice: 70000, stockQuantity: 15, category: { name: 'Electronics' }, baseUnit: 'Pcs', units: [{ name: 'Pcs', price: 74999, conversionQty: 1 }] },
    { _id: '4', name: 'Nescafe Coffee 500g', sku: 'FOOD001', barcode: '2234567890123', retailPrice: 1299, wholesalePrice: 1150, stockQuantity: 200, category: { name: 'Food & Beverages' }, baseUnit: 'Pcs', units: [{ name: 'Pcs', price: 1299, conversionQty: 1 }, { name: 'Box (6)', price: 7500, conversionQty: 6 }] },
    { _id: '5', name: 'Milo Pack 1kg', sku: 'FOOD002', barcode: '2234567890124', retailPrice: 899, wholesalePrice: 800, stockQuantity: 150, category: { name: 'Food & Beverages' }, baseUnit: 'Pcs', units: [{ name: 'Pcs', price: 899, conversionQty: 1 }, { name: 'Box (24)', price: 20000, conversionQty: 24 }] },
    { _id: '6', name: 'Coca-Cola 500ml (24 pack)', sku: 'FOOD003', barcode: '2234567890125', retailPrice: 2400, wholesalePrice: 2200, stockQuantity: 100, category: { name: 'Food & Beverages' }, baseUnit: 'Pack (24)', units: [{ name: 'Pack (24)', price: 2400, conversionQty: 24 }, { name: 'Pcs', price: 120, conversionQty: 1 }] },
    { _id: '7', name: 'Detergent Powder 1kg', sku: 'HOUSE001', barcode: '3234567890123', retailPrice: 450, wholesalePrice: 400, stockQuantity: 300, category: { name: 'Household' }, baseUnit: 'Pcs', units: [{ name: 'Pcs', price: 450, conversionQty: 1 }, { name: 'Pack (5)', price: 2000, conversionQty: 5 }] },
    { _id: '8', name: 'Cooking Oil 5L', sku: 'FOOD004', barcode: '2234567890126', retailPrice: 1800, wholesalePrice: 1650, stockQuantity: 80, category: { name: 'Food & Beverages' }, baseUnit: '5L', units: [{ name: '5L', price: 1800, conversionQty: 5 }, { name: '1L', price: 400, conversionQty: 1 }] },
    { _id: '9', name: 'Sugar 1kg', sku: 'FOOD005', barcode: '2234567890127', retailPrice: 250, wholesalePrice: 220, stockQuantity: 500, category: { name: 'Food & Beverages' }, baseUnit: '1kg', units: [{ name: '1kg', price: 250, conversionQty: 1 }, { name: '500g', price: 140, conversionQty: 0.5 }, { name: '2kg', price: 480, conversionQty: 2 }] },
    { _id: '10', name: 'Rice 2kg', sku: 'FOOD006', barcode: '2234567890128', retailPrice: 600, wholesalePrice: 550, stockQuantity: 200, category: { name: 'Food & Beverages' }, baseUnit: '2kg', units: [{ name: '2kg', price: 600, conversionQty: 2 }, { name: '1kg', price: 320, conversionQty: 1 }, { name: '5kg', price: 1400, conversionQty: 5 }] },
    { _id: '11', name: 'USB Cable', sku: 'MOBILE001', barcode: '4234567890123', retailPrice: 500, wholesalePrice: 450, stockQuantity: 150, category: { name: 'Mobile Accessories' }, baseUnit: 'Pcs', units: [{ name: 'Pcs', price: 500, conversionQty: 1 }, { name: 'Pack (5)', price: 2200, conversionQty: 5 }] },
    { _id: '12', name: 'Phone Charger', sku: 'MOBILE002', barcode: '4234567890124', retailPrice: 1200, wholesalePrice: 1000, stockQuantity: 75, category: { name: 'Mobile Accessories' }, baseUnit: 'Pcs', units: [{ name: 'Pcs', price: 1200, conversionQty: 1 }] },
  ];
